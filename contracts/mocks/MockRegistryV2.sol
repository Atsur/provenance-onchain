...
import { AtsurActorRegistry } from "../AtsurActorRegistry.sol";

/**
 * @title MockRegistryV2
 * @dev Test-only upgrade target — exists solely to prove storage continuity across a real
 *      UUPS upgrade in test/UpgradeFlow.test.js. Inherits AtsurActorRegistry's entire storage
 ...
 */
contract MockRegistryV2 is AtsurActorRegistry {
